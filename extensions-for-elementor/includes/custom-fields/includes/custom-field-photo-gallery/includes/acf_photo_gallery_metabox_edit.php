...
<div id="acf-photo-gallery-metabox-edit-<?php echo esc_attr($attachment); ?>" class="acf-edit-photo-gallery">
    ...
    <input class="acf-photo-gallery-edit-field" type="hidden" name="acf-pg-hidden-nonce" value="<?php echo esc_attr($nonce); ?>"/>
    <?php
    ...
    <div class="save-changes-wrap">
        <button class="button button-primary button-large" type="submit" data-fieldname="<?php echo esc_attr($acf_fieldkey); ?>" data-id="<?php echo esc_attr($attachment); ?>" data-ajaxurl="<?php echo esc_url(admin_url('admin-ajax.php')); ?>">Save Changes</button>
