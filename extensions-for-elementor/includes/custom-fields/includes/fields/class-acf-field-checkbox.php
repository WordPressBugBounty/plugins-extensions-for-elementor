		...
		*/
        ...
        function render_field_custom( $field ) {
            ...
            foreach ( $field['value'] as $value ) {
                ...
                ?>
                <li>
                    <input class="acf-checkbox-custom" type="checkbox" checked="checked" />
                    <?php echo acf_get_text_input( $text_input ); ?>
                </li>
                <li><a href="#" class="button acf-add-checkbox"><?php echo esc_html__( 'Add new choice', 'acf' ); ?></a></li>'
                <?php
                $html = ob_get_clean();
		...
		function walk( $choices = array(), $args = array(), $depth = 0 ) {
		    ...
		    foreach ( $choices as $value => $label ) {
		        ...
		        if ( is_array( $label ) ) {
		            ?>
		            <ul>
		                <?php echo $this->walk( $label, $args, $depth + 1 ); ?>
		            </ul>
		            <?php
		        } else {
