		...
		*/
		...
		function wp_nav_menu_item_custom_fields( $item_id, $item, $depth, $args, $id = '' ) {
			...
			if ( ! empty( $field_groups ) ) {
				...
				// open
                ?>
				<div class="acf-menu-item-fields acf-fields -clear">
                <?php
...
<div id="tmpl-acf-menu-settings" style="display: none;">
			...
			if ( ! empty( $field_groups ) ) {
				...
				foreach ( $field_groups as $field_group ) {
                    ...
                    ?>
                    <div class="acf-menu-settings -<?php echo esc_attr( $field_group['style'] ); ?>">
                        <h2><?php echo esc_html( $field_group['title'] ); ?></h2>
                        <div class="acf-fields -left -clear">
